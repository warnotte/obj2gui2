 ...
 *
 */
@PROPERTY_MIGLAYOUT(LayoutConstraints="fill")
...
public class DTOMig3
{
	...
	/*
	add(getComp1(), "cell 0 0");
	add(getComp2(), "cell 1 0 2 2");
	add(getComp3(), "cell 3 0");
	add(getComp4(), "cell 0 1");
	add(getComp5(), "cell 3 1");
	add(getComp6(), "cell 0 2");
	add(getComp7(), "cell 1 2");*/
	...
	@PROPERTY_MIG_GRID(attribut = "cell 0 1 2 1")
	...
	@PROPERTY_MIG_GRID(attribut = "cell 0 2 2 1")
	...
	@PROPERTY_MIG_GRID(attribut = "cell 0 3 2 1")
	...
	@PROPERTY_MIG_GRID(attribut = "cell 0 4 2 1")
	...
	@PROPERTY_MIG_GRID(attribut = "cell 0 5 2 1")
